...
const tableArray = ["Date/Time based events",
...
export const FeaturesPage = () => {
    return (
        ...
        >
            ...
            <div className='bg-transparent py-16 backdrop-blur-md'>
                <div className='w-11/12 mx-auto space-y-10 pb-16'>
                    <h1 className='text-6xl font-bold'>The
                        <span className='text-secondaryButton'> Features</span>
                    </h1>
                    <div className='text-xl text-gray-200'>
                        <p>Whether in front of a PC/Tablet or on the go with your phone,</p>
                    ...
                    <div className='grid grid-cols-3 gap-5 pb-10 mt-10 px-5'>
                        {
                            featureCard.map((data, i) => (
                                <FeatureCard color={data.color} icon={data.icon} key={i} desc={data.desc} tittle={data.title} />
                            ))
                        }
                    </div>
                </div>
            ...
            <div className='bg-white'>
                <div className="relative overflow-x-auto  w-10/12 mx-auto pt-14 ">
                    <h1 className='text-4xl font-bold text-center mb-10'>The Chasing Watts Advantage</h1>
                            ...
                            {tableArray.map((d, i) => (
                                <tr className="bg-white border-b " key={i}>
                                    ...
                                    <td className="px-6 py-4 ps-16 ">
                                        {i === 0 ? <MdCheck className='text-2xl font-bold' /> : <RxCross1 className='text-xl font-bold' />}
                                    </td>
                                </tr>
                            ))}
                        </tbody>
