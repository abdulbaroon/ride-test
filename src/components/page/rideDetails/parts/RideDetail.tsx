...
const RideDetail = ({ userLogin }: { userLogin: any }) => {
                ...
                <div className='p-8'>
                    <div className='flex flex-row justify-between items-center border-b'>
                        <div className='flex gap-2 pb-4'>
                            <div className='w-20 h-[75px] border overflow-hidden rounded-md'>
                                <div>
                        ...
                        <div className='space-x-4'>
                            <Link
                                href={`https://www.facebook.com/sharer/sharer.php?u=${MY_DOMAIN}/ride/${formatedRide.activityID}`}
                                target='_blank'>
                                <FontAwesomeIcon
                                    icon={faFacebook}
                                    size='lg'
                                    className='fa-fw text-neutral-500 hover:text-primaryText'
                                />
                            </Link>
                            <Link
                                href={`https://www.twitter.com/intent/tweet?url=${MY_DOMAIN}/ride/${formatedRide.activityID}&text=${formatedRide.rideName} via @ChasingWattsApp`}
                                target='_blank'>
                                <FontAwesomeIcon
                                    icon={faXTwitter}
                                    size='lg'
                            ...
                            <Link
                                href={`https://www.reddit.com/submit?url=${MY_DOMAIN}/ride/${formatedRide.activityID}&title=${formatedRide.rideName}`}
                                target='_blank'>
                                <FontAwesomeIcon
                                    icon={faReddit}
                                    size='lg'
                            ...
                            <Link
                                href={`https://www.threads.net/intent/post?text=${MY_DOMAIN}/ride/${formatedRide.activityID}`}
                                target='_blank'>
                                <FontAwesomeIcon
                                    icon={faThreads}
                                    size='lg'
                    ...
                    {showPrivateShare && (
                        <div className=' mt-4 border border-neutral-300 p-4 bg-white rounded-md'>
                            <span className='text-sm text-neutral-600'>
                                Ride Owner - Private Share Link. Anyone with
                                this link can view this ride!
                            </span>
                            <Alert
                                status='info'
                                variant='left-accent'
                    ...
                    <div className='py-4 border-b'>
                        ...
                        <div className='flex mt-1'>
                            ...
                            <div className='flex items-center gap-2 text-gray-700 ps-4'>
                                ...
                                <p>
                                    {formatedRide.distance} miles @{" "}
                                    {formatedRide.avgSpeed} mph
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='w-6/12'>
                            <div className='space-y-2'>
                                ...
                                (weatherForecast?.weatherDescription &&
                                    weatherForecast.weatherDescription.indexOf(
                                        "This ride is too far out for a forecast"
                                    ) > -1) ? (
                                    <div className='flex flex-row items-center'>
                                        ...
                                        <p className='ml-2 text-sm text-neutral-500'>
                                            ...
                                            <br />
                                            Check back when it is closer to the
                                            ride date!
                                        </p>
                                    </div>
                                ) : (
                        ...
                        ${
                            userRosterInfo?.responseTypeModel
                                ...
                                : " bg-[#fdbc31] text-white hover:bg-[#d09c2c]"
                                        ...
                                        {formatedRide?.rosterModal?.length >
                                            0 && (
                                            <button
                                                onClick={() =>
                                                    handleJoinRoster("No")
