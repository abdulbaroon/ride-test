    ...
    try {
      if (userData.userProfile && userData.id) {
        ...
        if (userprofile.rejected.match(response)) {
          ...
          toast.success(
            "Your profile has been saved! Create or find a ride! Let's ride."
          );
          profile();
        }
      } else {
      ...
      {!success ? (
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="w-full tablet:w-1/2 flex justify-center items-center flex-col">
                  ...
                  <div className="w-full">
                    ...
                    <div className="flex gap-3 justify-center items-center py-3 border rounded-lg px-2">
                      <input
                        {...register("rideStartRadius", {
                          required: "Ride start radius is required",
                          valueAsNumber: true,
                        })}
                        type="range"
                        min={0}
              ...
              <div className=" mt-6">
                ...
                <p className="text-xs text-[#244161]">
                  Your profile will be limited only connected users.
                </p>
              </div>
        ...
        <div className="flex flex-col justify-center items-center gap-1 w-full tablet:w-7/12 desktop:w-5/12 mx-auto mt-10">
          ...
          <div className="w-9/12 tablet:w-8/12 text-xs tablet:text-sm text-center text-secondaryButton">
            You will see any rides posted in {ride || 0} km radious of{" "}
            {getValues("homeLocation")}{" "}
          </div>
          <button
            type="button"
            onClick={() => router.push("#")}
