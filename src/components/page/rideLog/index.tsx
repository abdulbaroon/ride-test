        ...
        <>
            <div className='w-11/12 mx-auto !max-w-[1320px] mt-28 mb-5'>
                <div className='flex mb-6 mt-3  gap-5'>
                    <div
                        className={` bg-white w-1/2 rounded-md border border-neutral-300  p-6 mx-auto max-h-[395px] overflow-y-auto`}>
                        <div className=''>
                    ...
                    <div
                        className={` bg-white w-1/2 rounded-md border border-neutral-300 p-6 mx-auto h-fit`}>
                        <div className=''>
                            <p className='pb-4 text-2xl font-semibold'>
                                Ride Views
                            </p>
                ...
                <div className='grid grid-cols-4 gap-5'>
                    {activityrating?.map((data: any, index: number) => (
                        <div
                            key={index}
                            className='bg-white rounded-md border border-neutral-300 p-4  '>
