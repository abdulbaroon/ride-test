...
/**
 * MyRideModal component that displays a modal with the user's created or joined rides.
 *
 * @component
 * @param {Object} props - Component props
 * @param {boolean} props.isOpen - Indicates whether the modal is open.
 * @param {function} props.onClose - Function to call to close the modal.
 * @returns {JSX.Element} The rendered MyRideModal component.
 */
                    ...
                    <ModalBody>
                        <div className='overflow-hidden'>
                            ...
                            <div className='space-y-6 mt-2 max-h-[400px] overflow-y-auto'>
                                {formattedHotRide.length > 0 ? (
                                    formattedHotRide.map((data, index) => (
                                        <div className='flex gap-3' key={index}>
                                            <div className="w-32 h-32">
                                                <img src={data.mapImage} className='w-full h-full' alt="Ride Map" />
                                            </div>
                                    ...
                                    <div className='text-gray-600'>
                                        ...
                                        <Link className='text-primaryText' href={"/ride"}>Search for a ride!</Link>
                                    </div>
                                )}
                            </div>
                        </div>
