        ...
        <div className="mt-2 mb-5">
            <form onSubmit={handleSubmit(handleSubmits)} className="">
                <div className="space-y-2 mt-4">
                    <h1 className="text-2xl font-bold">Have a route mapped out? Ride with GPS or Strava? Public ride?</h1>
                    <p className="font-bold text-sm">Quickly create a ride from public or your created routes or rides and we'll load most of the ride details for you!</p>
                    <p className="font-bold text-sm pb-2">If not, no worries! Just select "No Route" and create a ride with just a start location.</p>
                </div>
                <div className="space-y-3 m-5 pt-6">
                    <div className="flex items-center me-4">
                        ...
                        <label htmlFor="gps-radio" className="ms-2 text-xl font-medium text-gray-900">RIDE WITH GPS</label>
                    </div>
                    <div className="flex items-center me-4">
                        <input id="strava-radio" type="radio" value="strava" {...register("routeType", { required: true })} className="w-4 h-4 bg-white border-gray-300" />
                        <label htmlFor="strava-radio" className="ms-2 text-xl font-medium text-gray-900">STRAVA</label>
                    </div>
                    <div className="flex items-center me-4">
                ...
                <div className="flex items-center text-gray-600 gap-2 border-b py-5 mt-9">
