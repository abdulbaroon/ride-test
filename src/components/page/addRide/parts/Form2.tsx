        ...
        <div className="flex gap-10">
          <div className="w-1/2">
            {formData?.routeType === "noroute" ? (
              <div className="text-xl tablet:text-2xl font-bold">{heading}</div>
            ) : (
              <>
                <div className="space-y-2 mt-4">
                  <h1 className="text-xl tablet:text-2xl font-bold">{heading}</h1>
                  {formData?.routeType === "gpx" ? (
                    <p className="font-extrabold text-base tablet:text-xl text-gray-400">
                      Have your own GPX FILE? Upload it and let&apos;s ride!
                    </p>
                  ) : (
                    <p className="font-extrabold text-base tablet:text-xl text-gray-400">
                      Copy any public route URL from {heading} or connect and easily use your own routes!
                    </p>
                  )}
                </div>
                {formData?.routeType === "gpx" ? (
          ...
          <>
            <div className="flex p-2 flex-col gap-1 text-gray-600 mt-3 text-sm tablet:text-base">
              ...
              <p>
                ...
                <Link href={"#"} className="text-primaryText">
                  {" "}
                  Authorize Chasing Watts & Strava to get started!{" "}
                </Link>
              </p>
            </div>
            <div className="flex my-3 gap-3 text-yellow-500 border border-yellow-400 rounded-lg p-4 bg-[#fff8ea] text-sm tablet:text-base">
              ...
              <p>
                Want to find or create new Strava route? Head over to
                <Link href={"#"} className="text-yellow-700 font-bold">
                  {" "}
                  {heading}{" "}
                </Link>
                and get started!
