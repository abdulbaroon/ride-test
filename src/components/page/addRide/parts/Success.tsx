...
const Success = () => {
    return (
        <div className='flex flex-col justify-center items-center  w-full tablet:w-7/12 desktop:w-5/12 mx-auto mt-28 gap-7'>
            ...
            <Link href={"#"} className='bg-transparent border border-secondaryButton text-secondaryButton text-center py-[9px] w-9/12 tablet:w-8/12 px-6 font-bold rounded-md flex justify-center items-center gap-3'>
