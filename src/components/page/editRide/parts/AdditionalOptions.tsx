...
const AdditionalOptions: React.FC<AdditionalOptionsProps> = ({ register, errors, data,setData}) => {
  ...
  useEffect(() => {
    if (data) {
      const tags = data?.activityTagModel?.map((tag: any) => ({ label: tag.activityTagName, value: tag.activityTagName }))
      setSelectTag(tags)
      setImage(data?.activityPictureModel
        ?.filter((item: any) => !item?.isMap)
        ?.map((item: any) => (IMAGE_URl + item?.picturePath))?.[0])
      const pdf = data?.hasWaiver
        ?
        IMAGE_URl +
        `/ridewaivers/ridewaiver_${data.activityID}.pdf`
        : null
      setWaiver(pdf)
  ...
  return (
    <div className="mt-2 mb-5 shadow-xl rounded-xl p-5 ">
      <div>
        ...
        <div className="flex gap-7 mt-5 flex-col tablet:flex-row">
          ...
          <div className="flex flex-col w-full tablet:w-1/2">
            ...
            <div className="flex flex-col relative mt-1">
              <select {...register('hubList')} className="bg-white border px-2 py-[6px]">
          ...
          <div className="mt-3">
            ...
            <div className="mt-1 relative">
              {typeof waiver === 'object' && image !== null ? (
                ...
                <embed src={waiver as string} type="application/pdf" width="400px" height="225px" />
              )}
          ...
          <div className="mt-3  overflow-hidden ">
            ...
            <div className="mt-1 relative w-[400px] h-[250px]">
              {typeof image === 'object' && image !== null ? (
                ...
                <img src={image} alt="Selected Ride Image" className=" " />
              )}
