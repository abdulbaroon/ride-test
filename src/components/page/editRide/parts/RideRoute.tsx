...
const RideRoute: React.FC<RideRouteProps> = ({ register, errors, loading, difficultyLevel, centerLatitude, centerLongitude, geoJSON,type }) => {
  return (
    <div>
     {geoJSON?.features&& <div className='border shadow-xl rounded-xl p-6 flex items-center gap-5  '>
        <div className="w-1/2 ">
          ...
          <div className="flex gap-2 tablet:gap-4 flex-col tablet:flex-col mt-3">
            <div className="flex flex-col w-full">
              ...
              <input
                ...
                {...register(`distance${type}`, { required: "Please enter the distance." })}
            ...
            <div className="flex flex-col  w-full">
              ...
              <input
                ...
                {...register(`avgSpeed${type}`, { required: "Please enter the average speed." })}
          ...
          <div className="flex gap-0 tablet:gap-4 mt-3">
            <div className="flex flex-col w-full relative">
              <select
                {...register(`difficulty${type}`, { required: "Please select a difficulty level." })}
          ...
          <div className="mt-4">
            <label className="inline-flex items-center cursor-pointer">
              <input {...register(`isGroup${type}`)} type="checkbox" className="sr-only peer" />
