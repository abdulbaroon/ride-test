        ...
        if (data) {
            ...
            if (data?.activityRouteModel[0]?.mapSourceID) {
                ...
                if (data?.activityRouteModel[0]?.mapSourceID === 5) {
                    ...
                    setValue(
                        "avgSpeedgpx",
                        data?.activityRouteModel[0]?.speed || ""
                    );
                    setValue(
                        "distancegpx",
                        data?.activityRouteModel[0]?.distance || ""
                    );
                    setValue(
                        "difficultygpx",
                    ...
                    setValue(
                        "routeNamelink",
                        data?.activityRouteModel[0]?.routeName
                    );
    ...
    const handleSubmits: SubmitHandler<FormData> = async (data) => {
        ...
        const routeData = {
            ...
            routeNumber: extractRouteId(
                features?.properties?.links?.[0]?.href ?? ""
            ),
            centerLatitude,
            centerLongitude,
            routeDistance,
                                                ...
                                                {currentTab === 0 && (
                                                    <>
                                                        ...
                                                        <RideRoute
                                                            ...
                                                            centerLatitude={
                                                                linkData?.centerLatitude
                                                            }
                                                            centerLongitude={
                                                                linkData?.centerLongitude
                                                            }
                                                            errors={errors}
                                                        />
                                                    </>
                                                ...
                                                {currentTab === 1 && (
                                                    <>
                                                        ...
                                                        <RideRoute
                                                            ...
                                                            centerLatitude={
                                                                gpxData?.centerLatitude
                                                            }
                                                            centerLongitude={
                                                                gpxData?.centerLongitude
                                                            }
                                                            errors={errors}
                                                        />
                                                    </>
