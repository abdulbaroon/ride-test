        ...
        <div className='w-11/12 mx-auto max-w-[1320px] mt-28'>
            <div className='flex w-full gap-5'>
                <div className='w-1/2 bg-white rounded-lg'>
                    ...
                    <div className='p-5 space-y-4 text-base text-gray-500'>
                        <p>
                            While chasing watts, you will also power up with the
                            joule points program! Through your interaction on
                            the Chasing Watts site and
                            <Link href={"/#app"} className='text-primaryText'>
                                {" "}
                                mobile apps
                            </Link>
                        ...
                        <p>
                            Create a ride, join a ride, chat, invite your
                            friends, and review rides - all will earn you points
                            that can get you limited swag and cool bike stuff!
                        </p>
                        <p>
                            Please{" "}
                            ...
                            us with any questions or feedback on the Joule
                            program!
                        </p>
                        <p>
                            Please note, adding content will earn points and
                            deleting content will deduct points equally.
                        </p>
                    </div>
                </div>
                    ...
                    <div className='p-5'>
                        ...
                        {leaderBoard.map((entry, index) => (
                            <div
                                ...
                                <p>
                                    {entry.pointAmount.toLocaleString(
                                        undefined,
                                        {
                        ...
                        {currentItems.length > 0 ? (
                            <>
                                {currentItems.map((point, index) => (
                                    <div
                                        ...
                                        <p className='w-3/12'>
                                            {dayjs(point.createdDate).format(
                                                "MM/DD/YYYY"
                                            )}
                                        </p>
                                        <p className='w-2/12'>
                            ...
                            <div className='py-2 px-5 bg-primaryGray space-y-6'>
                                <p className='text-gray-600'>
                                    Sorry, you have not earned any joules yet.
                                    Get out there - add or join a ride today!
                                </p>
