...
export const profileData = (userID: number) => [
    {
        link: `/friend/${userID}`,
...
export const sideBarData = (userID: number) => [
    {
...
export const steps = [
    ...
    },
    {
        ...
        description:
            "Create or find a ride in your local area in under one minute.",
    },
    {
        number: "03",
        title: "Join a ride",
        description:
            "Like a ride you see - join the roster and know all the details!",
    },
    {
        number: "04",
        title: "Ride & have FUN!",
