...
export const metadata: Metadata = {
  ...
  description: "Privac Policy for Chasing Watts",
};
          ...
          <div className="bg-white p-6 shadow-md rounded-md">
            ...
            <div className="space-y-4">
              <p className="text-gray-700">
                Thank you for choosing to be part of our community at Chasing
                Watts LLC (&quot;<strong>Company</strong>
                &quot;, &quot;
                <strong>we</strong>&quot;, &quot;<strong>us</strong>
                &quot;, or &quot;<strong>our</strong>&quot;). We are committed
                ...
                information, please contact us at support@chasingwatts.com.
              </p>
              <p className="text-gray-700">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>Visit our website at https://chasingwatts.com</li>
                <li>
